...
whoyourcreator = ["chi è il tuoi creatore?", "chi ti ha creato?", "chi ti ha inventato?", "parlami del tuo creatore", "chi è il tuo inventore?", "chi è il tuo programmatore?" ]
whoyourcreator_answer = ["Il mio creatore è Alessio Speranza, sono fiero di essere una sua creazione"]

newfeatures = ["ci sono nuove feature?", "ci sono nuovi comandi?", "quali sono i nuovi aggiornenti?", "hai nuovi aggiornamenti?", "hai nuove feature?", "hai nuovi comandi?"]
newfeatures_answer = ["Le ultime feature implementate sono: avvio programmi, lancio dadi e saluto che varia con l'ora del giorno. Sono in costante aggiornamento perciò presto potrai provare nuove funzionalità"]

futurefeatures = ["ci sono nuove feature in arrivo?", "ci sono nuovi comandi all'orizzonte?", "ci sono nuovi comandi in arrivo?" "ci saranno nuove feature?", "ci saranno nuovi comandi?"]
futurefeatures_answer = ["Le funzionalità in arrivo sono:  attivazione con comando vocale, personalizzazione dell'assistente, ricerca su wikipedia e su internet, informazioni meteo, ricompense crypto, inserimento metaverso. Nel caso volessi avere più informazioni sul progetto e le prossime funzionalità ti consiglio di visitare la pagina github del progetto o il sito"]
